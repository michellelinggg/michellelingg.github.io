...
return t&&!t.internal&&"component"===t.type?t.factory:void 0},e.getComponentTemplate=Mn,e.getDebugStack=void 0,e.getModifierManager=Pn,e.getTemplate=function(e){if(nr.hasOwnProperty(e))return nr[e]},e.getTemplates=function(){return nr},e.hasTemplate=function(e){return nr.hasOwnProperty(e)},e.helper=W,e.htmlSafe=at,e.isHTMLSafe=st,Object.defineProperty(e,"isSerializationFirstNode",{enumerable:!0,get:function(){return h.isSerializationFirstNode}}),e.iterableFor=Ne,e.modifierCapabilities=$r,e.renderSettled=function(){null===Xt&&(Xt=E.default.defer(),(0,s.getCurrentRunLoop)()||s.backburner.schedule("actions",null,Jt))
...
default:return h.clientBuilder.bind(null)}}}),e.injection("service:-dom-builder","bootOptions","-environment:main"),e.injection("renderer","builder","service:-dom-builder"),e.register((0,n.privatize)(P||(P=(0,t.taggedTemplateLiteralLoose)(["template:-root"]))),U),e.injection("renderer","rootTemplate",(0,n.privatize)(D||(D=(0,t.taggedTemplateLiteralLoose)(["template:-root"])))),e.register("renderer:-dom",rr),e.register("renderer:-inert",tr),m.hasDOM&&e.injection("service:-glimmer-environment","updateOperations","service:-dom-changes")
...
d=p.internal?new ir(m(o),f,l):new Rr(a,s.component,m(o),null!==l?l:o.lookup((0,n.privatize)(C||(C=(0,t.taggedTemplateLiteralLoose)(["template:components/-default"]))))(o))}}return null===d&&(d=new Ht(a,s.component||o.factoryFor((0,n.privatize)(M||(M=(0,t.taggedTemplateLiteralLoose)(["component:-default"])))),null,l)),h(),this.componentDefinitionCache.set(u,d),d},e}(),Fn={create:function(e){var t=e.environment
...
return t||(t=e._promiseCallbacks={}),t}Object.defineProperty(e,"__esModule",{value:!0}),e.Promise=e.EventTarget=void 0,e.all=P,e.allSettled=x,e.asap=$,e.cast=e.async=void 0,e.configure=a,e.default=void 0,e.defer=B,e.denodeify=S,e.filter=Y,e.hash=I,e.hashSettled=L,e.map=V,e.off=me,e.on=pe,e.race=N,e.reject=q,e.resolve=H,e.rethrow=z
...
return e?e.reload():this.load()},i=n,(o=[{key:"_id",get:function(){return this.internalModel.id}}])&&J(i.prototype,o),a&&J(i,a),n}($)
...
return void 0===t&&(t=new Me(e),ke.set(e,t)),t}var Me=function(){function e(e){var t=this
...
o&&o.destroyFromRecordData()},t=e,(r=[{key:"identifierCache",get:function(){throw new Error("Store.identifierCache is unavailable in this build of EmberData")}}])&&Ke(t.prototype,r),n&&Ke(t,n),e}()
...
e=Ember.get(r,"relationshipsByName").get(this.inverseKey)}this.__inverseMeta=e}return this.__inverseMeta}}])&&lt(t.prototype,r),n&&lt(t,n),e}()
...
return!e&&this.willSync&&(e=this.canonicalState.reduce((function(e,t){return e||!t.isEmpty()}),!1)),!e}}])&&ht(i.prototype,o),a&&ht(i,a),n}(ct)
...
return!(null!==e&&e.isEmpty())}}])&&pt(i.prototype,o),a&&pt(i,a),n}(ct)
...
return this.__implicitRelationships=e,e}return this.__implicitRelationships}},{key:"_inFlightAttributes",get:function(){return null===this.__inFlightAttributes&&(this.__inFlightAttributes=Object.create(null)),this.__inFlightAttributes},set:function(e){this.__inFlightAttributes=e}}])&&gt(t.prototype,r),n&&gt(t,n),e}()
...
return new Map(Object.entries(e))}}])&&Ot(t.prototype,r),n&&Ot(t,n),e}()
...
return e}function St(e,t){return(St=Object.setPrototypeOf||function(e,t){return e.__proto__=t,e})(e,t)}var Ct=Ember.run.backburner,Mt=(Ember.ENV,1),Pt=(i.has("@ember-data/serializer"),i.has("@ember-data/adapter"),function(e){var t,r
function n(){var t
...
return n.normalize(i,t)},s.newClientId=function(){return Mt++},s.recordWasLoaded=function(e){this.recordArrayManager.recordWasLoaded(e)},s._internalModelsFor=function(e){return Ce(this).modelMapFor(e)},s.adapterFor=function(e){var t=y(e),r=this._adapterCache,n=r[t]
if(n)return n
...
e.length=0},i=n,(o=[{key:"identifierCache",get:function(){throw new Error("Store.identifierCache is unavailable in this build of EmberData")}}])&&Tt(i.prototype,o),a&&Tt(i,a),n}(Ember.Service))
...
t[r]=n}return n}function Nt(e,t){return Ember.getOwner(e).factoryFor("model:"+t)}function jt(e,t){return(jt=Object.setPrototypeOf||function(e,t){return e.__proto__=t,e})(e,t)}Ember.defineProperty(Pt.prototype,"defaultAdapter",Ember.computed("adapter",(function(){var e=this.adapter||"-json-api"
...
r=Ember.get(n,"relationshipsObject")||null,this._relationshipsDefCache[e]=r}return r},i.getSchemaDefinitionService=function(){throw"schema service is only available when custom model class feature flag is on"},n}(Pt)
